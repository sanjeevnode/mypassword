  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="panel glow-border w-full max-w-sm rounded-none p-6 text-center">
        <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-none bg-violet-500/15 text-violet-300">
          <ShieldCheck size={19} />
        </div>
        <h3 className="text-base font-bold tracking-tight text-white">Confirm it&apos;s you</h3>
        <p className="mt-1 mb-4 text-[13px] text-zinc-400">
